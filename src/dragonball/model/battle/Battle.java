...
public class Battle implements Serializable {
	...
	public void play() throws NotEnoughKiException {
		if (new Random().nextInt(100) > 15) {
			...
			|| (randomAttack instanceof SuperAttack &&
			attackerFighter.getKi() >= 1)
			|| (randomAttack instanceof UltimateAttack &&
			 attackerFighter.getKi() >= 3)) {
			 break;
			 }
			 ...
			 //System.out.println("==> " +
			 //randomAttack.getClass().getSimpleName() + ": " +
			 //randomAttack.getName());
	...
	public void use(Player player, Collectible collectible)
			throws NotEnoughSenzuBeansException {
		switch (collectible) {
		case SENZU_BEAN:
